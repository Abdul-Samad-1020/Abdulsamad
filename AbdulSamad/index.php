...
<body class="bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 min-h-screen flex items-center justify-center p-4">
    <div class="backdrop-blur-lg bg-white/10 rounded-2xl shadow-2xl p-8 w-full max-w-md border border-white/20">
        <h1 class="text-3xl font-bold text-white text-center mb-6">CGPA Calculator</h1>
        <?php if($error): ?>
        ...
        <p class="text-white text-center mt-6">
            Don't have an account? <a href="register.php" class="underline font-semibold">Register</a>
        </p>
    </div>
</body>
</html>
